...
**Commit:** `4dd91f0b` — See `../audit/AUDIT.md ## Benchmark Results (P0-A + P0-C, 2026-02-25)`.

**Acceptance criteria:** ≥10 papers benchmarked ✅. Precision/recall/F1 in `../audit/AUDIT.md` ✅.
...
See `../audit/AUDIT.md ## Benchmark Results (P0-A + P0-C) → P0-C citation spot-check`.

**Acceptance criteria:** Manual spot-check documented. Citation grounding rate on molecular
genetics papers recorded in `../audit/AUDIT.md`. Known-good rate ≥60% on papers with explicit prose findings.
...
4. Document final threshold and calibration set in `../audit/AUDIT.md`.

**Acceptance criteria:** All benchmark molecular genetics papers pass screening.
Zero false negatives in the benchmark set. Threshold + calibration documented in `../audit/AUDIT.md`.
...
**Commit:** See `../audit/AUDIT.md ## Figure Extraction Benchmark (P2-A, 2026-02-26)`.

**Acceptance criteria:** ≥1 gene found exclusively via figure analysis on ≥1 paper ✅
(131 figure-only genes across 2 papers). Documented in `../audit/AUDIT.md` ✅.
