...
> - [`../../.claude/rules/memory-pipeline.md`](../../.claude/rules/memory-pipeline.md) — stage-level overview for Claude sessions. This doc goes deeper.
> - [`../../AUDIT.md`](../../AUDIT.md) — historical bug log.
> - [`../../CLAUDE.md`](../../CLAUDE.md) — project routing file.
...
Parse errors on individual papers in a batch are silently skipped. Affected PMIDs produce no PubTator results but the pipeline continues. This is documented in `AUDIT.md` as a known, accepted limitation.
...
See 13.6. The FDA auditor story is documented in `AUDIT.md` at the C18 entry.
...
- [`../../.claude/rules/memory-pipeline.md`](../../.claude/rules/memory-pipeline.md) — stage-level routing for Claude
- [`../../AUDIT.md`](../../AUDIT.md) — historical bug log
- [`../../CLAUDE.md`](../../CLAUDE.md) — project routing file
