...
>
> **History vs. current state:** [`AUDIT.md`](../../AUDIT.md) logs bugs that were already fixed. This doc lists code that is currently in production and should be reviewed.
...
**Impact.** False REVIEW tier. A known pain point with stochastic LLM compliance (see `AUDIT.md` C19, C22).
...
- **Historical bugs:** [`AUDIT.md`](../../AUDIT.md)
